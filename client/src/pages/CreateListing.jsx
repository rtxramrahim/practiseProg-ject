        ...
        <form onSubmit={handleSubmit} className='flex flex-col sm:flex-row gap-4'>
            <div className='flex flex-col gap-4 flex-1'>
                ...
                <div className='flex flex-wrap flex-row gap-4'>
                    ...
                    <div className='flex flex-row items-center gap-5'>
                        <input className='p-3 border border-gray-300 rounded-lg' onChange={handleChange} value={formdata.regularPrice} type='text' id='regularPrice' min='5000'></input>
                        <label htmlFor='regularPrice'>{`Price {₹ / month}`}</label>
                    </div>
                   {
                    formdata.offer &&  <div className='flex flex-row items-center gap-5'>
                        <input className='p-3 border border-gray-300 rounded-lg' onChange={handleChange} value={formdata.discountedPrice} type='text' id='discountedPrice' min='5000'></input>
